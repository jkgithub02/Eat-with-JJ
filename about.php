    ...
    <main>
        ...
        <section id="mission">
            <div class="container"> 
                ...
                <p>From the freshest ingredients to time-honored recipes,  we strive to transport you to Italy with every bite. </p>
                <p>Our mission is to create a warm and inviting atmosphere where you can savor delicious food, make memories, and feel like part of our family.</p>
            </div>
        </section>
        ...
        <section id="team">
            <div class="team-container">
                ...
                <div class="team-profiles"> 
                    <div class="profile">
                        <img src="assets/drinks/ilt.jpeg" alt="Head Chef">
                        <h3>Head Chef</h3>
        ...
        <div class="values-wrapper">  
            <section id="values">
                ...
                <p>We strive to create a friendly and welcoming atmosphere for every guest, ensuring a memorable dining experience.</p>
                </div>
            </section>
        </div>
    </main>
