  ...
  <main>
    <section id="hero">
      ...
      <div class="image-container">
        <img src="assets/pasta/lobster.jpeg" alt="lobster pasta">
      </div>
    </section>
    ...
    <div class="carousels-container">
      <div class="carousel">
        <ul class="carousel-slides">
          <li class="carousel-slide"><img src="assets/burgers/fish_burger.jpeg" alt="Image 1"></li>
          <li class="carousel-slide"><img src="assets/drinks/juice.jpeg" alt="Image 2"></li>
          <li class="carousel-slide"><img src="assets/pizza/hawaiian.jpeg" alt="Image 3"></li>
        </ul>
      </div>
      <div class="carousel">
        <ul class="carousel-slides">
